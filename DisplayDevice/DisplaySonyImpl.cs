...
{
    public class DisplaySonyImpl : IDisplay
    {
        ...
        {
            this.Display = new Display(name, ipAddress, deviceID, 20060);
            ...
            CrestronConsole.PrintLine($"Connecting to display at {ipAddress}");
        }
