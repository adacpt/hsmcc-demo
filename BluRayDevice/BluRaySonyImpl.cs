...
{
    public class BluRaySonyImpl : IBluRay
    {
        ...
        {
            this.BluRay = new BluRay(name, ipAddress, 23);


            this.BluRay.Client.Enable = true;
            this.BluRay.Client.DataReceived += OnDataReceived;
            this.BluRay.Client.DeviceConnected += Client_DeviceConnected;
            this.BluRay.Client.DeviceDisconnected += Client_DeviceDisconnected;
            PollingTimer.Enabled = true;


            CrestronConsole.PrintLine($"Connecting to BluRay at {ipAddress}");
        }
