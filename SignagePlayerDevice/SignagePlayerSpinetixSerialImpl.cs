...
{
    public class SignagePlayerSpinetixSerialImpl : ISignagePlayer
    {
        ...
        public SignagePlayerSpinetixSerialImpl()
        {
        ...
        {
            this.SignagePlayer = new SignagePlayer(name, serialPort, baudRate, timeZones);

            switch (baudRate)
            {
                case "9600":
                    this.SignagePlayer.SerialPort.SetComPortSpec(ComPort.eComBaudRates.ComspecBaudRate9600,
        ...
        {
            SignagePlayer.SerialPort.Send("MV?\r\n");
        }
